...
class DriftType(str, Enum):
    ...
    UNMANAGED_IN_ACTUAL = (
        "unmanaged_in_actual"  # Found in actual state, not defined in IaC
    )
...
class DriftInfo(BaseModel):
    ...
    actual_resource: Optional[ParsedResource] = (
        None  # The resource as found in actual state
    )
    attribute_drifts: List[AttributeDrift] = Field(
